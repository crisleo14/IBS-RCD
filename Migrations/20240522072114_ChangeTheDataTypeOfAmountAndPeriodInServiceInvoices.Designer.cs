...
namespace Accounting_System.Migrations
{
    ...
    [Migration("20240522072114_ChangeTheDataTypeOfAmountAndPeriodInServiceInvoices")]
    partial class ChangeTheDataTypeOfAmountAndPeriodInServiceInvoices
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Accounting_System.Models.BankAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Accounting_System.Models.JournalVoucherDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Accounting_System.Models.ServiceInvoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Accounting_System.Models.Services", b =>
                {
                    ...
                    b.Property<string>("CurrentAndPrevious")
                        .IsRequired()
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("Accounting_System.Models.DebitMemo", b =>
                {
                    b.HasOne("Accounting_System.Models.ServiceInvoice", "SOA")
                        .WithMany()
                        .HasForeignKey("SOAId");
            ...
            modelBuilder.Entity("Accounting_System.Models.JournalVoucherHeader", b =>
                {
                    b.HasOne("Accounting_System.Models.CheckVoucherHeader", "CheckVoucherHeader")
                        .WithMany()
                        .HasForeignKey("CVId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
